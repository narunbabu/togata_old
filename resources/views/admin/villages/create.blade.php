        ...
        <div class="container mt-4">
            ...
            <div class="row justify-content-center">
                <div class="col-md-5">
                    ...
                    {{ Form::hidden('mandal_id', 'secret', array('id' => 'myid')) }}
                    ...
                    <div id="#selectmandal-dd" class="form-group">
    ...
    <script>
        $(document).ready(function () {
            ...
            $('#mandal-dd').on('change', function () {
                var idState = this.value;
                console.log('this is value',idState);
                var y = document.getElementById("myid");
                // var x = document.createElement("INPUT");
                // y.setAttribute("type", "text");
                y.setAttribute("value", idState);
                // y.appendChild(x);

                
                // x.setAttribute("type", "text");
                // x.setAttribute("value", "myself");
                // $("#selectmandal-dd").html('');
                // $("#selectmandal-dd").append('<p>This is it</p>')
